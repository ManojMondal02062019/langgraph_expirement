            ...
            with st.spinner("Processing..."):   
                ...
                if user_input.lower() in ["exit", "quit", "bye"]:
                    ...
                    try:
                        ...
                        to_display = f"**Agent:** Is this what you need help with ? {state["messages"][-1].content}"
                        st.session_state.messages.append(to_display)
                        st.markdown(to_display)
                        aws_attr = AgentState["aws_service_attr"]
                        print(f"STATE Attribute ::::::::::: {aws_attr}")
                        user_intent = aws_attr['intent']
                        print(f" STATE - AWS Params :::::::: {user_intent}")
                        st.markdown("---")
